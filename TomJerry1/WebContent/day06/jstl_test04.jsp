...
<body>
	<div class="w3-content mxw2">
			...
			<div class="w3-col">
				<label for="id" class="w3-col m2 w3-right-align w3-padding">NAME : </label>
				<h3 class="w3-col m10 w3-padding" id="name">${param.name}</h3>
			</div>
			<div class="w3-col">
				<label for="id" class="w3-col m2 w3-right-align w3-padding">TEL : </label>
				<h3 class="w3-col m10 w3-padding" id="tel">${param.tel}</h3>
			</div>
			<div class="w3-col">
				<label for="id" class="w3-col m2 w3-right-align w3-padding">MAIL : </label>
